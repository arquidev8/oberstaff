...
<body class="bg-black dark:bg-gray-800">
    ...
    <div class="w-full mb-20 mt-20">
        <div class="mx-auto max-w-7xl px-6 lg:px-8 pt-8">
            <div class="mx-auto max-w-2xl text-center">
                 <h1
                class="text-4xl font-extrabold tracking-tight text-white dark:text-white  sm:text-5xl md:text-6xl">
                <span class="block xl:inline"><span class="mb-1 block">Bienvenidos al blog</span>
            ...
            <div class="mt-20 mx-auto grid max-w-2xl auto-rows-fr grid-cols-1 gap-8 sm:mt-12 lg:mx-0 lg:max-w-none lg:grid-cols-3">
                ...
                <article class="relative isolate flex flex-col justify-end overflow-hidden rounded-2xl bg-gray-900 dark:bg-gray-700 px-8 py-8 pb-8 pt-80 sm:pt-48 lg:pt-80">
                    ...
                    <div class="flex flex-wrap items-center gap-y-1 overflow-hidden text-sm leading-6 text-gray-300">
                        <time datetime="{{ $article->created_at->toDateString() }}" class="mr-8">{{ $article->created_at->format('M d, Y') }}</time>
                    </div>
