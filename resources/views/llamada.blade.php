...
<body>
  ...
  <iframe width='100%' height='750px' src='https://info-oberstaff.zohobookings.com/portal-embed#/4327750000001590002' frameborder='0' allowfullscreen='' > </iframe>
            ...
            <div class="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
                <div class="text-center xl:flex xl:items-center xl:justify-between xl:text-left">
                    <div class="xl:flex xl:items-center xl:justify-start gap-8">
                        ...
                        <p class="mt-5 text-sm text-gray-900 xl:ml-6 xl:mt-0 ml-8 mr-6">è¢Ì Copyright 2024</p>
                    </div>
